...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/burst2safe-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/burst2safe-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install burst2safe
```
...
It is possible to list all of the versions of `burst2safe` available on your platform:
...
```
pixi search burst2safe --channel conda-forge
```
